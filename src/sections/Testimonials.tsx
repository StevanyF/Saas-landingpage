...
const fistColumn = testimonials.slice(0,3);
      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-paragraph mt-5">
            From intuitive desigh to powerful features, our app has been an 
        ...
        <div className="flex justify-center gap-6 mt-10 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[738px]">
          <TestimonialColumn testimonials={fistColumn} duration={15} />
